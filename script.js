...
function animateText() {
    if (isTyping) {
        ...
        if (index > 1) {
            ...
            // Alterna a cor do texto entre branco/preto e rosa
            currentColor = currentColor === (document.documentElement.classList.contains('light') ? 'black' : '#fff') ? '#FF1493' : (document.documentElement.classList.contains('light') ? 'black' : '#fff');
